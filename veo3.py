...
# Prompt the user for an idea
user_idea = input("Enter your idea for the video: ")

# Generate the video based on the user's idea
try:
    generate(
        idea=user_idea,
        filename=f"{user_idea[:30].lower().replace(' ', '-')}.mp4",
    )
